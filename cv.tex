...
\entry{2018-2019}{{\normalfont MSc. Mathematics }{\normalfont and Founds. of Computer Science}}
...
\entry{2015-2018}{Courses and conferences}{}{Attended: {\small
    ...
    \item{\href{http://www.lambda.world/}{Lambda World}, on functional programming.}
      \item{\href{http://www.ugr.es/~orientamat/}{OrientaMat - LaTeX course}, volunteering as \textit{teaching assistant}.}
    \end{itemize}
  }
}
...
\begin{entrylist}
  \entry{2017-2018}{Category theory and λ-calculus}{\href{https://github.com/mroman42/lambda.notes}{Bachelor's thesis}}
...
\entry{2016-2017}{Koszul pairs and their applications}{\href{http://github.com/mroman42/math}{unpublished}}
...
\textit{A complete portfolio can be found at \href{https://mroman42.github.io}{mroman42.github.io}.}
 ...
 \begin{entrylist}
   \entry{2018}{Mikrokosmos: an educational lambda calculus interpreter}{}
   {
     \textit{Mario Román} \\
