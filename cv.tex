...
{\href{http://www.ugr.es/en/}{University of Granada}, Spain}
{\emph{Emphasis in computation.} Grade Point Average: 9.47/10
  {\small
    \begin{multicols}{2}
    \begin{itemize}[topsep=0pt]
    \item C++ Programming
...
\entry{2015-2017}{Courses and conferences}{}{Attended: {\small
    ...
    \item{\href{http://www.lambda.world/}{Lambda World}, on functional programming.}
      \item{\href{http://www.ugr.es/~orientamat/}{OrientaMat - LaTeX course}, as \textbf{teaching assistant}.}
    \end{itemize}
  }
}
...
\entry{2002-2012}{School of Music}{Granada, Spain}{ Foundational and
  professional level. Specialization in violin, music theory and
  composition.  }
\end{entrylist}
